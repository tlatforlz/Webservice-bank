                                    ...
                                    <ol class="opc" id="checkoutSteps">
                                        <li class="col-lg-4 col-md-4  col-sm-4  col-xs-12">
                                            <ul>
                                                ...
                                                <%
                                                    DONDATHANG dh = (DONDATHANG) request.getAttribute("DonDatHang");
                                                    String diachi = dh.getDiaChiGiaoHang();
                                                    String[] list_dc = diachi.split("-");
                                                    String firstname = list_dc[0];
                                                    String lastname = list_dc[1];
                                                    String phone = list_dc[list_dc.length - 1];
                                                    String address = "";
                                                    for (int i = 2; i < list_dc.length - 2; i++) {
                                                        address += list_dc[i];
                                                    }
                                                %>
                                                ...
                                                <form id="ship-form" method="post" action="ThanhToanV2">
                                                                ...
                                                                <ul class="form-list">
                                                                    ...
                                                                    <li class="col-lg-4 col-md-4  col-sm-4  col-xs-12">
                                                                        <ul>
                                                                            ...
                                                                            <li>
                                                                                <div class="panel panel-info">
                                                                                    <div class="panel-heading"> <span class="label label-warning">2</span> Thông tin đơn hàng</div>
                                                                                    <div id="checkout-step-payment" class="panel-body">
                                                                                        <div id="co-payment-main">
                                                                                            <script>
                                                                                                $(document).ready(function () {
                                                                                                    $("#method").val("p_method_emosys_pay123_standard");
                                                                                            ...
                                                                                            <fieldset>
                                                                                                ...
                                                                                                <dl class="sp-methods" id="checkout-payment-method-load">
                                                                                                    <%
                                                                                                        int thanhtoan = dh.getDaThanhToan();
                                                                                                        int giaohang = dh.getTinhTrangGiao();
                                                                                                        String kq_tt = "";
                                                                                                        if (thanhtoan == 0) {
                                                                                                            kq_tt = "Chưa thanh toán.";
                                                                                                        } else if (thanhtoan == 1) {
                                                                                                            kq_tt = "Đã thanh toán.";
                                                                                                        }
                                                                                                        ...
                                                                                                        if (dh.getDaHuy() == 1) {
                                                                                                            ...
                                                                                                            kq_gh = "Đã hủy đơn hàng";
                                                                                                        }
                                                                                                    %>
                                                                                                    Mã đơn hàng : 
                                                                                                    <p id="madonhang"><%=dh.getMaDonDatHang()%></p>
                                                                                                    <input style="display:none" name="madonhang" value="<%=dh.getMaDonDatHang()%>">
                                                                                                    Tình Trạng : 
                                                                                                    <p><%=kq_tt%></p>
                                                                                                    Chuyển phát : 
                                                                                                    <p><%=kq_gh%></p>
                                                                    ...
                                                                    <li class="col-lg-4 col-md-4  col-sm-4  col-xs-12">
                                                                        <div class="panel panel-info">
                                                                            <div class="panel-heading"> <span class="label label-warning">3</span> Xem đơn hàng</div>
                                                                                        ...
                                                                                        <table class="table review-table table-striped table-condensed" id="checkout-review-table">
                                                                                            ...
                                                                                            <tbody class="review-items">
                                                                                                <%
                                                                                                    ...
                                                                                                    ArrayList<CHITIETDATHANG> list_ct = ct_dp.getListCT(dh.getMaDonDatHang());
                                                                                                    for (CHITIETDATHANG gh : list_ct) {

                                                                                                        SANPHAM_DAO sp_dao = new SANPHAM_DAO();
                                                                                                        SANPHAM sp = sp_dao.getSanPham(gh.getTb_sanpham_MaSanPham());
                                                                                                %>
                                                                                                <tr>
                                                                                                    <td>
                                                                    ...
                                                                    <input style="display:none" id="thanhtoan" value="<%=dh.getDaThanhToan()%>">
                                                                    <script>
                                                                        function submitForm() {
                                                                            $("#ship-form").submit();
                                                                        }
                                                                        $(document).ready(function () {
                                                                            $("#huydh").on('click', function () {
                                                                                var madonhang = $("#madonhang").text();
                                                                                var thanhtoan = $("#thanhtoan").val();
                                                                                document.location.href = "HuyDonHang?MaDonHang=" + madonhang + "&ThanhToan=" + thanhtoan;
                                                                            });
                                                                        });
                                                                    </script>
                                                                    </ol>
