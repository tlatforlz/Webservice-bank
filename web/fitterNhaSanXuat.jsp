<%-- 
    Document   : fitter
    Created on : Mar 25, 2017, 03:09:30 AM
    Author     : tranl
--%>
                                ...
                                <div class="toolbar-bottom">
                                    <div class="toolbar" role="toolbar">
                                        <%
                                            ...
                                            int start = 12;
                                            try {
                                                MaNSX = (String) request.getAttribute("MaNSX");
                                                SoLuongCheck = sp_dao2.SoLuongSanPhamNhaSanXuat(MaNSX);
                                            ...
                                            if (SoLuongCheck > 12) {
                                                if (start != -1) {
                                        %>
                                        <a href="PhanTrangNhaSanXuat?MaNSX=<%=MaNSX%>&start=<%=start%>" method="GET">
